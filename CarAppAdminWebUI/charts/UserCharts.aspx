<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="UserCharts.aspx.cs" Inherits="CarAppAdminWebUI.charts.UserCharts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <script>
        ...
        function getUserData(startDate, endDate, container, type, title) {
            $.ajax({
        ...
        function query() {
            getUserData($("#txtstarttime").val(), $("#txtendtime").val(), "weeklydata", "weeklyregist", "周注册用户统计");
            getUserData($("#txtstarttime").val(), $("#txtendtime").val(), "monthlydata", "monthregist", "月注册用户统计");
            getUserData($("#txtstarttime").val(), $("#txtendtime").val(), "dailydata", "dailyregist", "日注册用户统计");
            getUserData($("#txtstarttime").val(), $("#txtendtime").val(), "yearlydata", "yearlyregist", "年注册用户统计");
        }
        $(function () {
            getUserData($("#txtstarttime").val(), $("#txtendtime").val(), "weeklydata", "weeklyregist", "周注册用户统计");
            getUserData($("#txtstarttime").val(), $("#txtendtime").val(), "monthlydata", "monthregist", "月注册用户统计");
