<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="OrderCharts.aspx.cs" Inherits="CarAppAdminWebUI.charts.OrderCharts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    function getOrderWeeklyData(startDate, endDate, container,type,title) {
           ...
           function query() {
                   getOrderWeeklyData($("#txtstarttime").val(), $("#txtendtime").val(), "weeklydata","weekly","周完成订单统计");
                 getOrderWeeklyData($("#txtstarttime").val(), $("#txtendtime").val(), "monthlydata","monthly","月完成订单统计");
                  getOrderWeeklyData($("#txtstarttime").val(), $("#txtendtime").val(), "dailydata","daily","日完成订单统计");
                    getOrderWeeklyData($("#txtstarttime").val(), $("#txtendtime").val(), "yearlydata","yearly","年完成订单统计");
           }
            $(function () {
                getOrderWeeklyData($("#txtstarttime").val(), $("#txtendtime").val(), "weeklydata","weekly","周完成订单统计");
                 getOrderWeeklyData($("#txtstarttime").val(), $("#txtendtime").val(), "monthlydata","monthly","月完成订单统计");
