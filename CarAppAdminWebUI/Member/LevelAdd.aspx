<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LevelAdd.aspx.cs" Inherits="CarAppAdminWebUI.Member.LevelAdd" %>
...
<body>
    <div style="padding: 5px;">
        ...
        <table class="adm_8" border="0" cellpadding="0" cellspacing="0" width="98%">
            ...
            <tr>
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="addscoreLL" name="scoreLL" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  />-<input class="adm_21" id="addscoreUL" name="scoreUL" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  />
                </td>
            </tr>
            <tr>
                <td class="adm_45" align="right" height="30" width="22%">
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="adddiscount" name="discount" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  /> 0-100之间的数字
                </td>
            </tr>
            <tr>
                <td class="adm_45" align="right" height="30" width="22%">
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="addorder" name="order" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  />
                </td>
            </tr>
        </table>
        </form>
    ...
    <script type="text/javascript">
        ...
        function checkForm() {
            ...
            var scoreLl = $.trim($("#addscoreLL").val());
            if (scoreLl == "") {
            ...
            var scoreUl = $.trim($("#addscoreUL").val());
            if (scoreUl == "") {
            ...
            var discount = $.trim($("#adddiscount").val());
            if (discount == "") {
