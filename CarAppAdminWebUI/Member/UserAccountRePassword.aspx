<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAccountRePassword.aspx.cs"
    Inherits="CarAppAdminWebUI.Member.UserAccountRePassword" %>
...
<body>
    <div style="padding: 5px;">
        <form id="addForm">
        <input type="hidden" id="action" name="action" value="repassword" />
        ...
        <table class="adm_8" border="0" cellpadding="0" cellspacing="0" width="98%">
            ...
            <tr>
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="password" name="password" type="text" />
                </td>
            </tr>
             <tr>
                <td class="adm_45" align="right" height="30" width="22%">
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="repassword" name="repassword" type="text" />
                </td>
            </tr>
        </table>
        </form>
    ...
    <script type="text/javascript">
        ...
        function checkForm() {
            ...
            if (password == "") {
                showValidateMessage("请输入密码");
                return false;
            }
            if (repassword == "") {
                showValidateMessage("请输入确认密码");
                return false;
            }
            if (password != repassword) {
                showValidateMessage("两次输入密码不一致");
                return false;
            }
            return true;
        }
