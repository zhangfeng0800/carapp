<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserHobbyEdit.aspx.cs" Inherits="CarAppAdminWebUI.Member.UserHobbyEdit" %>
...
<body>
       <form id="editForm">
        ...
        <input type="hidden" id="Id" name="Id" value="<%=Hobby.Id %>" />
        <table class="adm_8" border="0" cellpadding="0" cellspacing="0" width="98%">
            <tr>
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="Name" name="Name" value="<%=Hobby.Name %>" />
                </td>
            </tr>
             <tr>
                <td class="adm_45" align="right" height="30" width="22%">
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="Image" name="Image" value="<%=Hobby.Image %>" />
             ...
             <tr>
                ...
                <td class="adm_42" width="78%" colspan="3">
                        <input class="adm_21" id="Sort" name="Sort" value="<%=Hobby.Sort %>"  onkeyup="this.value=this.value.replace(/\D/g,'')"  />
                </td>
            </tr>
        </table>
