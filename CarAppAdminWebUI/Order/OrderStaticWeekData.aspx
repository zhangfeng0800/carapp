<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="OrderStaticWeekData.aspx.cs" Inherits="CarAppAdminWebUI.Order.OrderStaticWeekData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <script src="/Static/easyui/datagrid-groupview.js" type="text/javascript"></script>
    <form id="schForm">
    <input id="action" name="action" value="weekday" type="hidden" />
    ...
    <script type="text/javascript">
        ...
        function bindGrid() {
            $('#gdgrid').datagrid({
                ...
                columns: [
                [
                { field: 'timespan', title: '时间', width: 200 },
