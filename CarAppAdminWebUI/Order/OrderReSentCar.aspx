<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="OrderReSentCar.aspx.cs" Inherits="CarAppAdminWebUI.Order.OrderReSentCar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getSeachText() {
            ...
            var townid = $("#province").val();
            if (townid != '') {
                townid = $("#province option:selected").text();
            }
            if (rcCartype == '不限') {
                rcCartype = '';
            }
...
//                         { field: 'GpsTime', title: 'GPS上传时间', width:150 }
        ...
        function fstatus(value,row,index) {
            var arr = new Array("工作中", "离开或请假", "空闲中", "已出发", "已经就位", "订单已接取","其它","租出");
            return arr[value - 1];
        }
        ...
        function RunAction(carid) {
            ...
            if (r) {
                  var d = { "action": "resentcar", "id": "<%=Request.QueryString["id"] %>", "carid": carid };
