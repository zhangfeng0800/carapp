<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true"
    CodeBehind="OrderCountData.aspx.cs" Inherits="CarAppAdminWebUI.Order.OrderCountData" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <script src="/Static/easyui/datagrid-groupview.js" type="text/javascript"></script>
    <form id="schForm">
    <input id="action" name="action" value="datacount" type="hidden" />
    <div class="container" id="querycontainer">
        <div class="con_border">
            ...
            <div class="con_bg clearfix">
                ...
                <%--    <span class="input_blo"><span class="input_text">用户姓名</span> <span
                    class="">
            ...
            $('#gdgrid').datagrid({
                ...
                groupFormatter: function (value, rows) {
                  ...
                  for (var num = 0; num < rows.length; num++) {
                      ordercount += rows[num].ordercount;
                      ordermoney += rows[num].ordermoney;
                  }
                    num = 0;
                  return value + ' - ' +ordercount + ' 个完成订单，总金额：'+ parseFloat(ordermoney).toFixed(2)+"元";
                },
                columns: [
                [
                { field: 'name', title: '用车方式', width: 200 },
                { field: 'ordercount', title: '订单数量', width: 200 },
                    { field: 'ordermoney', title: '订单金额（元）', width: 200 }
                ]
                ]
            });
        }
