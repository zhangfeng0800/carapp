<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="OrderOriginStatics.aspx.cs" Inherits="CarAppAdminWebUI.Order.OrderOriginStatics" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <script src="/Static/easyui/datagrid-groupview.js" type="text/javascript"></script>
    <form id="schForm">
    <input id="action" name="action" value="orderorigin" type="hidden" />
    ...
    <script type="text/javascript">
        ...
        function bindGrid() {
            $('#gdgrid').datagrid({
                ...
                columns: [
                [
                { field: 'source', title: '订单来源', width: 200 },
