<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="OrderCarTypeData.aspx.cs" Inherits="CarAppAdminWebUI.Order.OrderCarTypeData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <script src="/Static/easyui/datagrid-groupview.js" type="text/javascript"></script>
    <form id="schForm">
    <input id="action" name="action" value="cartypecount" type="hidden" />
        ...
        <div class="con_border">
            ...
            <div class="con_bg clearfix">
                <span class="input_blo"><span class="input_text">日期</span> <span class="">
                  ...
                  <span class="input_blo"><span class="input_text"></span><span class="">
    ...
    <script type="text/javascript">
        ...
        function bindGrid() {
            $('#gdgrid').datagrid({
                ...
                columns: [
                [
                { field: 'typename', title: '车辆类型', width: 200 },
                { field: 'totalorder', title: '订单数量', width: 200 },
                    { field: 'totalmoney', title: '订单金额（元）', width: 200 }
                ]
                ]
            });
        }
