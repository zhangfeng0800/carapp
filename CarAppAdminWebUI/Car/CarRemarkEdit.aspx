<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CarRemarkEdit.aspx.cs" Inherits="CarAppAdminWebUI.Car.CarRemarkEdit" %>
        ...
        <table class="adm_8" border="0" cellpadding="0" cellspacing="0" width="98%">
            <tr>
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <textarea id="content" name="content" cols="60" rows="5"> <%=model.Content %></textarea>（最大长度100）
                </td>
            </tr>
            <tr>
                <td class="adm_45" align="right" height="30" width="22%">
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input id="sort" name="sort" value="<%=model.SortOrder %>" style="width: 67px; height: 21px;" onkeyup="this.value=this.value.replace(/\D/g,'')" />（从大到小排列）
                </td>
            </tr>
        </table>
        </form>
