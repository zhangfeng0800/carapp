<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerAdd.aspx.cs" Inherits="CarAppAdminWebUI.Manager.ManagerAdd" %>
        ...
        <table class="adm_8" border="0" cellpadding="0" cellspacing="0" width="98%">
            ...
            <tr>
             <td class="adm_45" align="right" height="30" width="22%">
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="Text1" name="Jobnumber" type="text" /><span>当前最大工号：<%=maxjobnumber%></span>
                </td>
            </tr>
            <tr>
                <td class="adm_45" align="right" height="30" width="22%">
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <select class="adm_21" id="addadminGroupsId" name="adminGroupsId">
