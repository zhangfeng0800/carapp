<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImgUpLoad.aspx.cs" Inherits="CarAppAdminWebUI.Weixin.ImgUpLoad" %>
...
<head runat="server">
    <title></title>
        ...
        *
        ...
        function showmessage(id, path, med, mediaid) {
            parent.document.getElementById(id).value = path;
            parent.document.getElementById(med).value = mediaid;
            alert('上传成功');
        }
    </script>
</head>
<body>
    ...
    <a href="javascript:void(0);" class="btn_addPic"><span><em>+</em>上传图片</span>
    <asp:FileUpload
