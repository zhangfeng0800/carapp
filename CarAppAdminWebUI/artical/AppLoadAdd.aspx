<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppLoadAdd.aspx.cs" Inherits="CarAppAdminWebUI.artical.AppLoadAdd" %>
       ...
       <form id="addForm">
        ...
        <table class="adm_8" border="0" cellpadding="0" cellspacing="0" width="98%">
            <tr>
                ...
                <select class="adm_21" name="State" id="State">
             ...
             <tr>
                ...
                <td class="adm_42" width="78%" colspan="3">
                    <input class="adm_21" id="Image" name="Image" style="width:350px;"  readonly="readonly"/>
             ...
             <tr>
                ...
                <td class="adm_42" width="78%" colspan="3">
                        <input class="adm_21" id="Version" name="Version" value="0" onkeyup="this.value=this.value.replace(/\D/g,'')"  />
                        (安卓客户端会显示版本号最大的图片)
                </td>
            </tr>
        </table>
