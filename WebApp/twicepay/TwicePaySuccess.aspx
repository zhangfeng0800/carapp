<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TwicePaySuccess.aspx.cs" Inherits="WebApp.twicepay.TwicePaySuccess" %>
...
<body>
	...
	<%--	<h3 class="til">订单支付</h3>--%>
		...
		<div class="pay-end">
         ...
         <a class="btn" id="setOut" href="http://m.iezu.cn/pcenter/UC_Default.aspx">
            返回个人中心</a>
	</div>
    </form>
</body>
