<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderPaySuccess.aspx.cs"
    Inherits="WebApp.OrderPaySuccess" %>
...
<body>
    ...
    <div class="dc-process clearfix">
        <div class="pay-ok">
            ...
            <p>
                <span runat="server" id="payType"></span><strong class="order-text"><span runat="server"
                    id="orderNum"></span></strong><em class="em-red"><span id="memCenter" runat="server">
                    </span></em>
            </p>
            <p class="clearfix">
